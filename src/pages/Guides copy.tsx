        ...
        <div className="container relative z-10 py-20">
          <div className="max-w-4xl mx-auto">
            ...
            <GoogleBleuSearch
              ...
              popularSearches={[
                { label: "CROUS", query: "logement crous" },
                { label: "Titre de séjour", query: "titre séjour vls-ts" },
                { label: "Sécurité sociale", query: "sécurité sociale ameli" },
                { label: "Compte bancaire", query: "ouvrir compte bancaire" },
                { label: "Transport", query: "transport navigo métro" },
                { label: "Travail étudiant", query: "travail étudiant 20h" },
              ]}
